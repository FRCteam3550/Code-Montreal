...
public class OI {
	...
	private Joystick JoystickSecondPilote;
	...
	public OI() {
		...
		//JoystickSecondPilote = new Joystick(2);
		int BUTTON_1 = 1;
		//int BUTTON_A = 2;
		//int BUTTON_B = 3;
		//int BUTTON_Y = 4;
		...
		Button buttonInverseDrive = new JoystickButton(gamePadPilote, NORMAL_INVERSE_BUTTON);// Button4
		buttonInverseDrive.whenPressed(new RbtxArcadeDriveInversedCommand());
		//buttonInverseDrive.whenPressed(new RbtxInverseTankDriveCommand());
		
		Button buttonDrive = new JoystickButton(gamePadPilote, NORMAL_BUTTON);// Button2
		buttonDrive.whenPressed(new RbtxArcadeDriveCommand());
		//buttonDrive.whenPressed(new RbtxTankDriveCommand());
		
		Button buttonInverseSlowTankDrive = new JoystickButton(gamePadPilote, SLOW_INVERSE_BUTTON);//Button1
		...
		Button buttonSlowTankDrive = new JoystickButton(gamePadPilote, SLOW_BUTTON);//Button3
		...
		Button buttonDeplacerShooter = new JoystickButton(gamePadPilote, BUTTON_1);
		buttonDeplacerShooter.whenPressed(new RbtxDeplacerStraightShooterTeleopCommand(1.75, 0.5));
		
		
		// Copilote
		joystickCoPilote = new Joystick(1);
		final int BOUTON_1   = 1;
		final int BOUTON_2   = 2;
		...
		Button buttonLancer90 = new JoystickButton(joystickCoPilote, BOUTON_2);
		buttonLancer90.whenPressed(new RbtxShooter90Command());
		
		Button buttonLancer80 = new JoystickButton(joystickCoPilote, BOUTON_10);
		buttonLancer80.whenPressed(new RbtxShooter80Command());
		
		Button buttonLancer70 = new JoystickButton(joystickCoPilote, BOUTON_12);
		buttonLancer70.whenPressed(new RbtxShooter70Command());
		
		//Button buttonCameraTourne = new JoystickButton(joystickCoPilote, BOUTON_10);
		//buttonCameraTourne.whileHeld(new RbtxAccelerPIDPourLancerAutomatiqueCommand(3000)); //Angle positif pour droite
		...
		Button buttonResetEncoder = new JoystickButton(joystickCoPilote, BOUTON_8);
		buttonResetEncoder.whenPressed(new RbtxResetEncoderCommand());// to be tested ASAP
	...
	public Joystick getJoystickSecondPilote(){
		return JoystickSecondPilote;
	};
	...
	public void logCoPiloteJoystick(){
		...
		SmartDashboard.putBoolean("Buttton8", Robot.oi.joystickCoPilote.getRawButton(8));
		SmartDashboard.putBoolean("Button10", Robot.oi.joystickCoPilote.getRawButton(10));
		SmartDashboard.putBoolean("Button12", Robot.oi.joystickCoPilote.getRawButton(12));
