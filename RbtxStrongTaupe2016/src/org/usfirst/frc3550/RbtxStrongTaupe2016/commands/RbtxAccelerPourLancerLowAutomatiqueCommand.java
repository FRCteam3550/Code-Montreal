 ...
 */
public class RbtxAccelerPourLancerLowAutomatiqueCommand extends Command {
    ...
    public RbtxAccelerPourLancerLowAutomatiqueCommand() {
    ...
    protected void execute() {
    	//boolean  accelerateurPret = false;
    	//SmartDashboard.putBoolean("Accelerateur Pret", accelerateurPret);
    	Robot.shooter.preparerVitesseMinimale();
