...
public class RbtxLancerPourAutomatiqueCommand extends Command {
    ...
    protected void initialize() {
    	...
    	Timer.delay(2); //change from 3 to 2 and again from 2 to 3 in Montreal
    	setTimeout(3); // change from 8 seconds to 5 seconds and has to be tested with the new value
    }
