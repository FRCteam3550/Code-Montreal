 ...
 */
public class RbtxSlowDriveInverseCommand extends Command {

    public RbtxSlowDriveInverseCommand() {
    ...
    protected void execute() {
    	 Robot.deplacement.inverseDriveSlow(Robot.oi.getgamePadPiloteY(), Robot.oi.getgamePadPiloteX());
    }
