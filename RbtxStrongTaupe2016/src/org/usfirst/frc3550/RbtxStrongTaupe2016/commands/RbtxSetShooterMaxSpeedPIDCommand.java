    ...
    public RbtxSetShooterMaxSpeedPIDCommand(double setpointMaxSpeed) {
    	...
    	PIDShooterSpeed = new PIDController(Kp_shooterSpeed, Ki_shooterSpeed, Kd_shooterSpeed, 
			...
			public double pidGet() {
				// TODO Auto-generated method stub
				currentSpeed = Robot.shooter.getCurrentShooterSpeed();// for debugging purpose can be deleted once the code is validated
				return Robot.shooter.getCurrentShooterSpeed();
			}
			...
			public void pidWrite(double output) {
				// TODO Auto-generated method stub
			   Robot.shooter.setShooterRPM(output);	
			}
		});
    }
