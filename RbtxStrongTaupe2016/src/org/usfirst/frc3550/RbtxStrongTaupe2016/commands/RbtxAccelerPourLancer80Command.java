 ...
 */
public class RbtxAccelerPourLancer80Command extends Command {
    ...
    public RbtxAccelerPourLancer80Command() {
    ...
    protected void initialize() {
    	...
    	setTimeout(5); //change from 9 seconds to 4 seconds and should be tested with the new value
    }
