 ...
 */
public class RbtxAccelerPourLancer70Command extends Command {
    ...
    public RbtxAccelerPourLancer70Command() {
    ...
    protected void initialize() {
    	...
    	setTimeout(5); //change from 9 seconds to 5 seconds and should be tested with the new value
    }
    ...
    protected void execute() {
    	boolean  accelerateurPret = false;
    	SmartDashboard.putBoolean("Accelerateur Pret", accelerateurPret);
    	Robot.shooter.accelererVitesse70();
